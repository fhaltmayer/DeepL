...
def convert_maxpool(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_avgpool(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_global_avg_pool(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
