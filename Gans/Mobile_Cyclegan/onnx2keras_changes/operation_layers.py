...
def convert_clip(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert clip layer
...
def convert_log(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert Log layer
    :param node: current operation node
    :param params: operation attributes
...
def convert_exp(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert Exp layer
    :param node: current operation node
    :param params: operation attributes
...
def convert_reduce_sum(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert reduce sum.
    :param node: current operation node
    :param params: operation attributes
...
def convert_reduce_mean(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert reduce mean.
    :param node: current operation node
    :param params: operation attributes
...
def convert_reduce_max(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert reduce max.
    :param node: current operation node
    :param params: operation attributes
...
def convert_pow(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert Pow layer
    :param node: current operation node
    :param params: operation attributes
...
def convert_sqrt(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert Sqrt layer
    :param node: current operation node
    :param params: operation attributes
...
def convert_split(node, params, layers, lambda_func, node_name, keras_names, test_c_order = False):
    """
    Convert Split layer
    :param node: current operation node
    :param params: operation attributes
...
def convert_cast(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert Cast layer
    :param node: current operation node
    :param params: operation attributes
...
def convert_floor(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert Floor layer
    :param node: current operation node
    :param params: operation attributes
...
def convert_identity(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_argmax(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_reduce_l2(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
