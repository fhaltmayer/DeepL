...
def convert_transpose(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert transpose.
...
def convert_shape(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert shape.
    :param node: current operation node
    :param params: operation attributes
...
def convert_gather(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert gather.
    :param node: current operation node
    :param params: operation attributes
...
def convert_concat(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert concat.
    :param node: current operation node
    :param params: operation attributes
...
def convert_reshape(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert reshape.
    :param node: current operation node
    :param params: operation attributes
...
def convert_unsqueeze(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert unsqueeze.
    :param node: current operation node
    :param params: operation attributes
...
def convert_flatten(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert flatten.
    :param node: current operation node
    :param params: operation attributes
...
def convert_slice(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert slice.
    :param node: current operation node
    :param params: operation attributes
...
def convert_squeeze(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_expand(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
