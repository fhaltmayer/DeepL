...
def convert_relu(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_elu(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_lrelu(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_sigmoid(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_tanh(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_selu(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_softmax(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_prelu(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
