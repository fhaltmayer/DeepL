...
def convert_elementwise_div(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_elementwise_add(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_elementwise_mul(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_elementwise_sub(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
...
def convert_min(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert Min layer
    :param node: current operation node
    :param params: operation attributes
...
def convert_max(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert Max layer
    :param node: current operation node
    :param params: operation attributes
...
def convert_mean(node, params, layers, lambda_func, node_name, keras_name, test_c_order = False):
    """
    Convert Mean layer
    :param node: current operation node
    :param params: operation attributes
